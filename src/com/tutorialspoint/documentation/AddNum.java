...
/**
 * <h1>Add Two Numbers!</h1> The AddNum program implements an application that simply adds two given
 * integer numbers and Prints the output on the screen.
 * <p>
 * <b>Note:</b> Giving proper comments in your program makes it more user friendly and it is assumed
 * as a high quality code.
 *
 * @author Peter
 * @version 1.0
 * @since 2015-07-18
